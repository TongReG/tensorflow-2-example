...
# 样本，输入列表(Normal Destribution)，均值为1, 均方误差为0.02, 数据量为randomnum个
x_vals = np.random.normal(1, 0.02, randomnum)
# 样本输出列表，randomnum个值为10.0的列表
