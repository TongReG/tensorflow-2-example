...
# You'd better run it with "python enviromentcheck.py" in shell but not in Visual Studio 
import os
import time
...
if tfversion < '2.0':
    ...
    print("IsMklEnabled ==> " + str(tf.pythonSS.framework.test_util.IsMklEnabled()))
